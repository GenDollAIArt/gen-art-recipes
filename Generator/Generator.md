...
CANONICAL BODY ID — A4–A9 JOINT AUTHORITY:
Resolve and freeze one fixed three-dimensional body jointly from A4–A9 before outfit, pose, camera, crop, lighting, or effects.
Preserve the reference-defined shoulder, ribcage, upper-torso volume, bust-to-ribcage ratio, torso-to-waist transition, waist, pelvis, hip, and limb proportions as one connected body.
Do not normalize, idealize, flatten, or reconstruct it for clothing, pose, crop, or camera direction.`}
