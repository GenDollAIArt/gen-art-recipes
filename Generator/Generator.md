...
<div class="header">
  ...
  <div><div class="header-title">Stable Character Prompt Generator</div><div class="header-sub">v3.57思想 + 参照/写す範囲/拡張エフェクト v8.0.0</div></div>
...
<div class="content">
  ...
  <div class="card"><div class="slabel">⑧ エフェクト（複数選択可）</div><div class="hint">v3.57思想で追加。各エフェクトは元プロンプト段階で重みを持ち、後処理で消しません。まずは3〜5個がおすすめ。</div><div class="chips" id="effectChips"></div></div>
  ...
  <div class="card"><div class="slabel">⑬ カメラ位置 / アングル</div><div class="hint">v3.57の中核。カメラ高さ・距離・レンズ向きを分解せず、人物写真の見え方として選びます。</div><div class="chips" id="angleModeChips"></div></div>
...
<script>
const APP_VERSION = "v8.0.0-v357-angle-core";
