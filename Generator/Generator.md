...
const EFFECTS = [
  {label:"🌫️ 背景ボケ", value:"(clearly visible background bokeh blur:1.8), (shallow depth of field with noticeably defocused background:1.8)", help:"背景をぼかして人物を目立たせます。\n駅・街・カフェなど背景がごちゃつく時に便利。場所説明は少し弱くなります。"},
  {label:"✨ 光の玉ボケ", value:"(clearly visible light orb bokeh:1.8), (ambient light circles in background:1.8), (noticeable specular bokeh highlights:1.8)", help:"背景のライトを丸い玉ボケにします。\n夜景・駅・街灯・店内照明に向きます。昼の自然光だけだと出にくいです。"},
  {label:"💧 水滴/結露感", value:"(clearly visible condensation droplets on glass or skin:1.7), (noticeable water droplet texture:1.7)", help:"雨・窓・ガラス・湿度感を出します。\n晴れの屋外では少し不自然になることがあります。"},
  {label:"✨ きらめき粒子", value:"(clearly visible sparkling glitter particles in air:1.7), (noticeable shimmering light particles:1.7)", help:"空気中にキラキラ感を足します。\n可愛い・幻想的・日差しの演出向き。曇り・雨・霧では自動で選べないようにしています。"},
  {label:"🌁 ソフトフォーカス", value:"(clearly visible soft focus haze:1.7), (gentle dreamy blur on edges:1.7), (noticeable diffused hazy atmosphere:1.7)", help:"全体を少し柔らかくします。\n夢っぽい・淡い写真向き。シャープな顔や服の質感は少し弱まります。"},
  {label:"🌙 逆光/リムライト", value:"(clearly visible backlighting:1.8), (noticeable rim light on hair and shoulders:1.8), (silhouette-edge glow:1.7)", help:"髪や肩の輪郭に光を入れます。\n夕方・夜・窓際・ビル街で映えます。顔が少し暗くなることがあります。"},
  {label:"📼 VHSノイズ", value:"(clearly visible VHS scan lines:1.7), (retro analog video noise:1.7), (noticeable chromatic aberration:1.7)", help:"古いビデオ風ノイズ。\nレトロ・荒い雰囲気向き。顔や文字、肌が崩れやすいので強いリアル写真には不向きです。"},
  {label:"🔥 暖色フレア", value:"(clearly visible warm lens flare:1.8), (golden warm flare streaks across frame:1.8)", help:"暖かい光の筋を入れます。\n夕方・逆光・ロマンティック系に合います。冷色フィルターとは競合します。"},
  {label:"❄️ 冷色フィルター", value:"(clearly visible cool blue color grading:1.8), (strong cold tone filter:1.8)", help:"青く冷たい色味にします。\n夜・雨・クール系に向きます。暖色フレアやゴールド系とは競合します。"},
  {label:"🌈 光漏れ", value:"(clearly visible light leak effect:1.8), (film light leak streaks across frame:1.8)", help:"フィルム写真の光漏れ風。\nエモい・レトロ・夕方に向きます。入れすぎると顔に光がかぶります。"},
  {label:"🖤 ビネット", value:"(clearly visible vignette:1.7), (noticeable dark edge falloff around frame:1.7)", help:"画面の端を暗くして中心に視線を集めます。\nムーディ・夜・映画風向き。明るい透明感とは相性が悪いことがあります。"},
  {label:"🎞️ フィルムグレイン強め", value:"(clearly visible heavy film grain:1.8), (pronounced analog grain texture:1.8)", help:"粒状感を強めます。\nフィルム感・レトロ感が出ます。肌のなめらかさや顔の安定は少し落ちます。"},
  {label:"☀️ 自然光ハイライト", value:"(clearly visible soft natural daylight:1.7), (noticeable highlight on nose bridge and forehead:1.7)", help:"鼻筋や額に自然光の明るさを出します。\n昼・窓際・屋外に向きます。夜景や暗い室内では不自然になることがあります。"},
  {label:"📱 スマホHDR", value:"(clearly visible smartphone HDR rendering:1.8), (smartphone tonal lift and clean dynamic range:1.8)", help:"スマホ写真っぽく明暗を持ち上げます。\n自撮り・昼・駅・街中に合います。フィルムの渋さは少し弱まります。"},
  {label:"🤍 白肌オーバー露光", value:"(clearly visible slight overexposure on fair skin:1.8), (clean pale skin rendering:1.8)", help:"肌を少し明るく白めに見せます。\n透明感や明るい自撮り向き。白飛びしすぎると顔の立体感が弱まります。"},
  {label:"🫧 透明感カラー", value:"(clearly visible airy transparent color grading:1.8), (smooth but realistic translucent skin texture:1.7)", help:"全体を薄く清潔な透明感に寄せます。\n肌・白シャツ・曇り・カフェに合います。粒状・暗め・強い色とは競合しやすいです。"},
  {label:"🌤️ 低コントラスト影", value:"(clearly visible low-contrast facial shadows:1.8), (soft even daylight shadow transition:1.8)", help:"影を柔らかくします。\n顔を優しく見せたい時に便利。ドラマチックな光と影は弱まります。"},
  {label:"📐 自撮り広角感", value:"(clearly visible natural selfie wide-angle perspective:1.8), (noticeable perspective stretch from smartphone front camera:1.7)", help:"スマホ自撮りっぽい広角感を足します。\n近距離自撮りに向きます。顔や腕が伸びすぎる場合は外してください。"}
];
...
let state = {
  ...
  effects: [], selfieMode: "", angleMode: "", subjectSize: "", backgroundView: "", framing: "", photoStyle: "", tension: "", emotion: "", expression: "",
};
let tokyoNow = {};
...
// ── Build prompt ──────────────────────────────────────────────────────────────
function buildPrompt(t, situation, characterLock, bustPrompt, hipPrompt, weatherVal, filmVal, toneVal, effectsArr, subjectSizeMode, backgroundViewMode, framingMode, photoStyleMode, angle, expression, scene, accessories, motionText) {
  const overviewParts = [];
...
function handleGenerate() {
  ...
  const prompt = buildPrompt(t, situation, characterLock, bustPrompt, hipPrompt, state.weather, state.film, state.tone, state.effects, subjectSizeMode, backgroundViewMode, framingMode, photoStyleMode, angle, expression, scene, accessories, motionText);
...
function handleReset() {
  ...
  state = { characterMode:"light", bust:"", hip:"", weather:"", film:"", tone:"", effects:[], selfieMode:SELFIE_MODE_OPTIONS[0].value, angleMode:ANGLE_UI_OPTIONS[0].value, subjectSize:SUBJECT_SIZE_MODES[0].value, backgroundView:BACKGROUND_VIEW_MODES[0].value, framing:FRAMING_MODES[0].value, photoStyle:PHOTO_STYLE_MODES[0].value, tension:"", emotion:"", expression:"" };
